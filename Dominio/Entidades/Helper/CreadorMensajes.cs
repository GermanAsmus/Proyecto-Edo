...
namespace Dominio.Entidades.Helper
{
    ...
    public static class CreadorMensajes
    {
        ...
        private static IMensaje AgregarDestinatarios(IMensaje pMensajeDTO, ICollection<ICuenta> pDestinatario)
        {
        ...
        public static IMensaje CrearMensaje(ICuenta pCuentaDTO, string pAsunto, ICollection<ICuenta> pDestinatario, string pContenido = "")//, ICollection<IAdjunto> pAdjuntos = null)
        {
